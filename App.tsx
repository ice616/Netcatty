...
function App({ settings }: { settings: SettingsState }) {
  ...
  const _handleTrayJumpToSession = useEffectEvent((sessionId: string) => { return handleTrayJumpToSessionImpl(() => ({ sessionId, sessions, setActiveTabId, setWorkspaceFocusedSession, unhideSession }), sessionId); });
